...
A list of open issues can be found here. (https://github.com/Planetfall/PlanetfallSS13/issues)
...
* We ask that you use the changelog system to document your change, which prevents our players from being caught unaware by changes - you can find more information about this [on this wiki page](https://github.com/Planetfall/PlanetfallSS13/wiki/Guide-to-Changelogs).
